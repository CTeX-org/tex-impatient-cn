...
\ifoldeplain\else
   \def\stringify{\expandafter\strip@prefix\meaning\temp}%
   \let\oldxrdef = \xrdef
   \def\xrdef#1{\def\temp{#1}\oldxrdef{\stringify}}%
   \let\oldxrefn = \xrefn
   \def\xrefn#1{\def\temp{#1}\oldxrefn{\stringify}}%
   \let\old@definelabel = \@definelabel
   \def\@definelabel#1{\def\temp{#1}\old@definelabel{\stringify}}%
...
%
\def\idxref#1{\ifoldeplain\indexwrite{#1}N\ignorespaces\else\sidx{#1}\fi}
...
%
\def\ctsidxref #1{\ifoldeplain\indexwrite{#1}C\ignorespaces\else\sidx{#1}\fi}
