...
\def\indexwrite#1#2{%
   ...
   \mainentry = \expandafter{\temp}%
   %
   \edef\tempa{\the\subentry}\def\tempb{}%
   \ifx\tempa\tempb
      \edef\idxstring{\the\mainentry}%
   \else
      \edef\idxstring{\the\mainentry!\the\subentry}%
   \fi
   \expandafter\sidx\expandafter{\idxstring}%
