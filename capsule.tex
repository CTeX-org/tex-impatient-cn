...
即内建于 \TeX\ 计算程序中的命令\seeconcept{primitive}。
...
\capcs lineskip {如果行之间的距离小于|\\lineskiplimit| 时，从一个基线到另一个基线的垂直粘连，默认值为 1\pt}*{}
